...
SELECT * FROM ORDERS.TPCH_SF100.ORDERS_2;
...
-- Query materialized view -- MUCH FASTER, 0.4 seconds.
SELECT * FROM ORDERS_MATERIALIZED_VIEW
ORDER BY "ORDER_YEAR";



-- Query from normal table -- MUCH SLOWER, ALMOST 10 SECONDS.
SELECT * FROM ORDERS
